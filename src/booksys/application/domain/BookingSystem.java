...
public class BookingSystem
{
  ...
  {
    Enumeration num = observers.elements() ;
    while (num.hasMoreElements()) {
      BookingObserver bo = (BookingObserver) num.nextElement() ;
      bo.update() ;
    }
  }
  ...
  {
    selectedBooking = null ;
    Enumeration num = currentBookings.elements() ;
    while (num.hasMoreElements()) {
      Booking b = (Booking) num.nextElement() ;
  ...
  private boolean doubleBooked(Time startTime, int tno, Booking ignore)
  {
    ...
    Enumeration num = currentBookings.elements() ;
    while (!doubleBooked && num.hasMoreElements()) {
      Booking b = (Booking) num.nextElement() ;
